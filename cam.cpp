...
int main(int argc, char* argv[]) {
    ...
    // Eigen::SparseLU<Eigen::SparseMatrix<float>> solver; // +- 1500 ms for 64x64
    // Eigen::ConjugateGradient<Eigen::SparseMatrix<float>> solver; // +- 1600 ms for 64x64
    Eigen::BiCGSTAB<Eigen::SparseMatrix<float>> solver; // +- 1350 ms for 64x64
