...
class JART_VCM_v1b_var {
    ...
    public:
        ...
        double Ndiscmin = 0.001;      // from [0.0001:100], minimum oxygen vacancy concentration in the disc [10^26/m^3]
        // double Ndiscmin = 0.008;      // from [0.0001:100], minimum oxygen vacancy concentration in the disc [10^26/m^3]
        double Ninit = 0.001;         // from [0.0001:1000], initial oxygen vacancy concentration in the disc [10^26/m^3]
